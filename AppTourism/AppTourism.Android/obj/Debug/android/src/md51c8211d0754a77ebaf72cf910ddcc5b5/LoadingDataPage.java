...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppTourism.Droid.LoadingDataPage, AppTourism.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", LoadingDataPage.class, __md_methods);
	}


	public LoadingDataPage () throws java.lang.Throwable
	{
		super ();
		if (getClass () == LoadingDataPage.class)
			mono.android.TypeManager.Activate ("AppTourism.Droid.LoadingDataPage, AppTourism.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
